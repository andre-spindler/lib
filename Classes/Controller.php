...
class Controller extends Object {
	 ...
	 * @var string
	 */
	var $contextClassName = '\\Spin\\Lib\\Context';

	/**
	 * Configurations class name
	 *
	 * @var string
	 */
	var $configurationsClassName = '\\Spin\\Lib\\Configurations';

	/**
	 * Typically you don't need to make a subclass of this
	 *
	 * @var string
	 */
	var $parametersClassName = '\\Spin\\Lib\\Parameters';

	/**
	 * Object containing the context accessing object.
	 *
	 * @var Context
	 */
	var $context = NULL;
	...
	/**
	 * current contentObject, setting done by TYPO3 Core
	 *
	...
	function __construct($parameter1 = NULL, $parameter2 = NULL) {
		$this->constructController($parameter1, $parameter2);
	}
	 ...
	 * @param mixed $parameter2
	 */
	function constructController($parameter1 = NULL, $parameter2 = NULL) {
	 ...
	 *
	 * @param     string   $input Incomming content if any.
	 * @param  mixed    $configurations Array with the local TypoScript configuration. Object if called as
	 * subcontroller.
	 * @param  object   $context Context object if called as subcontroller.
	 * @param  object   $parameters Parameters object if called as subcontroller.
...
//		return new $className($this);
		return GeneralUtility::makeInstance($this->parametersClassName, $this);
	}
	 ...
	 *
	 * @param    array        $configurationArray the local configuration array provided by the outer tslib framework
	 * @return  Configurations the configuration object
	 * @access    protected
	 */
	function _createConfigurations($configurationArray) {
//		$object = tx_div::makeInstance($this->configurationsClassName);
		$object = GeneralUtility::makeInstance($this->configurationsClassName, $this);
		$object->controller($this);
	 ...
	 * customized.
	 *
	 * @param      array       $controllerAndAction ControllerName and actionName.
	...
	function _findControllerAndAction() {
		...
		foreach (array_keys((array)$GLOBALS['TYPO3_CONF_VARS']['CONTROLLERS'][$classname]) as $childName)
	 ...
	 *
	 * @param    Configurations        $object Configurations or child
	 * @return    Configurations        Configurations or child
	 */
	function configurations(Configurations $object = NULL) {
	 ...
	 *
	 * @param    Parameters        $object Parameters or child
	 * @return    Parameters        Parameters or child
	 */
	function parameters(Parameters $object = NULL) {
	 ...
	 *
	 * @param    Context        $object Context or child
	 * @return    Context        Context or child
	 */
	function context(Context $object = NULL) {
	...
	/**
	 * Create objects of Object type in the typical way
	 *
	 * Useful for objects that inherit the tx_lib_object constructor.
	 *
	 ...
	 * @param mixed   $arrayOrObject Incomming SPL data for the constructor.
...
//		return new $className($this, $arrayOrObject);
		return GeneralUtility::makeInstance($className, $this, $arrayOrObject);
	}
