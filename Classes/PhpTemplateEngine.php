 ...
 */
class PhpTemplateEngine extends ViewBase {
	...
	function __construct($parameter1 = NULL, $parameter2 = NULL) {
		$this->PhpTemplateEngine($parameter1, $parameter2);
	}
	 ...
	 * @param mixed $parameter2
	 */
	function PhpTemplateEngine($parameter1 = NULL, $parameter2 = NULL) {
	 ...
	 * @param    mixed        $format format string or key of configuraton or empty
	 * @return    void
	 * @see        asDate()
	 */
	...
	/**
	 * Print a string parsed for standard text field input (parseFunc).
	 *
	 * Behaves analogous to $this->asTextField().
	 *
	 * @param    mixed        $key key of the internal data array
	 * @return    void
	 * @see        asText()
	 */
	function printAsTextField($key) {
		print $this->asTextField($key);
	}
	 ...
	 * without the tag. If both fails nothing is returned.
	 *
	 * @param    mixed        $urlKey key of the email field
	 * @param    mixed        $labelKey key of the label field
	 * @return    void
	 * @see        asUrl()
	 */
